...
cl::Program::Binaries bins{{filebuf.data(), filebuf.size()}};			//not working
//bins.push_back({filebuf,nb});
...
kernel_matmul = cl::Kernel(program,"matmul",&err);	//matmul is the name of the kernel top function in HLS
