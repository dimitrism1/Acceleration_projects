...
////////////// Alternative test way to measure fpga speed ///////////////////
  ...
  q.enqueueNDRangeKernel(kernel_matmul,1,1,1,nullptr,&event2);
  q.finish();
  event2.getProfilingInfo<uint64_t>(CL_PROFILING_COMMAND_START, &nstimestart);
  event2.getProfilingInfo<uint64_t>(CL_PROFILING_COMMAND_END, &nstimeend);
